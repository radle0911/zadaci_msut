...
// Sada postavljamo kada se stisne dugme USER
    ...
    GPIOA->MODER |= 0x00000000; // ovo ssmo izmjenili sa |= 0x00000000
    ...
    // potrebno je napraviti varijablu 
    ...
    while(1){
        ...
        GPIOD->ODR &= ~0xf000;
        // &=~0xf000 = 0000 1111 1111 1111 
        // zasto ne radi kada postavimo |= 0x0000;
        }
    }
    // zasto ne radi kada uradim samo GPIOA->IDR == 0x0001 ????
    // koja je razlika ? 

}
// ovaj primjer je isti kao i primjer
// u direktoriju gpio-input-pb samo sam ga ja 
// ovo sam uradio 
void delay_ms(uint32_t ms){
    volatile uint32_t us = ms * 10500;
    // pretvaramo u mikro sekunde
    while(us)
    --us;
